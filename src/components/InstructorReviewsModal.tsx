              ...
              {[5, 4, 3, 2, 1].map((stars) => {
                ...
                return (
                  <div key={stars} className="flex items-center gap-2.5 text-[var(--ink-dim)]">
                    ...
                    <span className="w-6 text-right font-medium text-[var(--ink-dim)]">{count}</span>
                  </div>
                );
              })}
            </div>
                    ...
                    <div className="flex items-start justify-between gap-3">
                      <div className="flex items-center gap-2.5">
                        <div className="w-8 h-8 rounded-none overflow-hidden bg-black/15 border border-[var(--border)] flex items-center justify-center shrink-0">
                          {rev.userAvatar ? (
                            <img src={rev.userAvatar} alt={rev.userName} className="w-full h-full object-cover filter grayscale" />
                          ) : (
