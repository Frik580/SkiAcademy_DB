              ...
              <div className="lg:col-span-4 border border-[var(--border)] p-6 bg-transparent self-start transition-colors duration-300 animate-fade-in">
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="space-y-1.5">
                    <label className="text-[10px] font-mono text-[var(--ink-dim)] uppercase block">{t('coachFullName')}</label>
                    <input
                      type="text"
                      required
                      value={name}
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-1.5">
                      ...
                      >
                        <option value="ski" className="bg-slate-50 dark:bg-slate-900 text-[var(--ink)]">{t('specialtySki')}</option>
                        <option value="snowboard" className="bg-slate-50 dark:bg-slate-900 text-[var(--ink)]">{t('specialtySnowboard')}</option>
                        <option value="both" className="bg-slate-50 dark:bg-slate-900 text-[var(--ink)]">{t('specialtyBoth')}</option>
                      </select>
                    </div>
                    <div className="space-y-1.5">
                      <label className="text-[10px] font-mono text-[var(--ink-dim)] uppercase block">{t('ratePerHourLabel')}</label>
                      <input
                        type="number"
                        required
                        value={pricePerHour}
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-1.5">
                      <label className="text-[10px] font-mono text-[var(--ink-dim)] uppercase block">{t('experienceYrsShort')}</label>
                      <input
                        type="number"
                        required
                    ...
                    <div className="space-y-1.5">
                      <label className="text-[10px] font-mono text-[var(--ink-dim)] uppercase block">{t('languagesCsv')}</label>
                      <input
                        type="text"
                        required
                        value={languages}
                  ...
                  <div className="space-y-1.5">
                    <label className="text-[10px] font-mono text-[var(--ink-dim)] uppercase block">{t('bioStatement')}</label>
                    <textarea
                      required
                      rows={3}
                      value={bio}
                  ...
                  <div className="flex gap-2 pt-2 font-mono">
                    ...
                    >
                      {isSubmitting ? <Loader2 className="w-3.5 h-3.5 animate-spin" /> : editingIns ? t('saveUpdates') : t('addCoachShort')}
                    </button>
                    <button
                      type="button"
                      onClick={() => {
