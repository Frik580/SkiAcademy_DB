...
const copy = {
  en: {
    ...
    payFromWallet: 'Debit from balance',
    clientBalance: 'Client balance',
    insufficientWallet: 'Insufficient client balance for this payment.',
    confirmWalletPayment: 'Debit {amount} from the linked client’s balance?',
  ...
  ru: {
    ...
    payFromWallet: 'Списать с баланса',
    clientBalance: 'Баланс клиента',
    insufficientWallet: 'Недостаточно средств на балансе клиента.',
    confirmWalletPayment: 'Списать {amount} с баланса привязанного клиента?',
