  ...
  return (
    <div className="border border-[var(--border)] p-5 bg-black/5 dark:bg-white/5 rounded-none space-y-4">
      <div className="border-b border-[var(--border)] pb-2.5">
        <h4 className="font-serif text-lg font-light text-[var(--ink)]">{t('resortDetailsTitle')}</h4>
        ...
        <form onSubmit={handleSaveResortConfig} className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="col-span-1 md:col-span-2 border-t border-[var(--border)] pt-6 mt-4">
              ...
              <p className="text-[9px] text-[var(--ink-dim)] mt-0.5 mb-4">{t('heroSliderDesc')}</p>
            </div>
                      ...
                      <div key={slide.id} className="border border-[var(--border)] p-4 bg-black/5 dark:bg-white/5 space-y-3 relative">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 pt-4">
                          <div className="space-y-3 border-r border-[var(--border)]/40 pr-0 md:pr-4">
                            ...
                            <div className="space-y-1">
                              ...
                              <input type="text" required value={slide.line1En} onChange={(e) => handleUpdateSlideField(slide.id, 'line1En', e.target.value)} className="w-full bg-transparent border border-[var(--border)] px-2.5 py-1 font-mono text-xs text-[var(--ink)] focus:outline-none focus:border-[var(--ink)] rounded-none" />
                            </div>
                            <div className="space-y-1">
                              <label className="block text-[9px] font-mono uppercase tracking-wider text-[var(--ink-dim)]">Line 2 (Main heading)</label>
                              <input type="text" required value={slide.line2En} onChange={(e) => handleUpdateSlideField(slide.id, 'line2En', e.target.value)} className="w-full bg-transparent border border-[var(--border)] px-2.5 py-1 font-mono text-xs text-[var(--ink)] focus:outline-none focus:border-[var(--ink)] rounded-none" />
                            </div>
                            <div className="space-y-1">
                              <label className="block text-[9px] font-mono uppercase tracking-wider text-[var(--ink-dim)]">Line 3 (Details)</label>
                              <textarea required rows={2} value={slide.line3En} onChange={(e) => handleUpdateSlideField(slide.id, 'line3En', e.target.value)} className="w-full bg-transparent border border-[var(--border)] px-2.5 py-1 font-mono text-xs text-[var(--ink)] focus:outline-none focus:border-[var(--ink)] rounded-none resize-none" />
                            </div>
                          </div>
                          ...
                          <div className="space-y-3">
                            ...
                            <div className="space-y-1">
                              ...
                              <input type="text" required value={slide.line1Ru} onChange={(e) => handleUpdateSlideField(slide.id, 'line1Ru', e.target.value)} className="w-full bg-transparent border border-[var(--border)] px-2.5 py-1 font-mono text-xs text-[var(--ink)] focus:outline-none focus:border-[var(--ink)] rounded-none" />
                            </div>
                            <div className="space-y-1">
                              <label className="block text-[9px] font-mono uppercase tracking-wider text-[var(--ink-dim)]">Строка 2 (Основной заголовок)</label>
                              <input type="text" required value={slide.line2Ru} onChange={(e) => handleUpdateSlideField(slide.id, 'line2Ru', e.target.value)} className="w-full bg-transparent border border-[var(--border)] px-2.5 py-1 font-mono text-xs text-[var(--ink)] focus:outline-none focus:border-[var(--ink)] rounded-none" />
                            </div>
                            <div className="space-y-1">
                              <label className="block text-[9px] font-mono uppercase tracking-wider text-[var(--ink-dim)]">Строка 3 (Описание)</label>
                              <textarea required rows={2} value={slide.line3Ru} onChange={(e) => handleUpdateSlideField(slide.id, 'line3Ru', e.target.value)} className="w-full bg-transparent border border-[var(--border)] px-2.5 py-1 font-mono text-xs text-[var(--ink)] focus:outline-none focus:border-[var(--ink)] rounded-none resize-none" />
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="pt-2 border-t border-[var(--border)]/40 grid grid-cols-1 md:grid-cols-2 gap-3 items-end">
                          <div className="space-y-1.5">
                            ...
                            >
                              <option value="random" className="bg-[var(--bg)] text-[var(--ink)]">{t('randomPresetWall')}</option>
                              ...
                              <option value="custom" className="bg-[var(--bg)] text-[var(--ink)]">{t('customImageUrlOption')}</option>
                            </select>
                          </div>
