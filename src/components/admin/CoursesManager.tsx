                        ...
                        <td className="px-4 py-2">
                          <div className="flex items-center gap-2 flex-wrap">
                            ...
                            {translatedCourse.levelLabel && (
                              <span
                                className={`border text-[8px] font-bold px-1.5 py-0.5 uppercase tracking-wide rounded-none shrink-0 ${
                  ...
                  {instructors.map((ins) => {
                    ...
                    return (
                      <button
                        ...
                        onClick={() => {
                          if (isSelected) {
                            setSelectedCourseInstructors((prev) =>
