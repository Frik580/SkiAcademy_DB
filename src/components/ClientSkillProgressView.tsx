...
export const ClientSkillProgressView: React.FC<ClientSkillProgressViewProps> = ({
  ...
  return (
    <div ref={containerRef} className="border border-slate-200/70 dark:border-slate-800/70 p-5 bg-[var(--card-bg)] rounded-xs shadow-xs space-y-6">
        ...
        <div className="relative flex items-center justify-center shrink-0">
          <svg className="w-20 h-20 transform -rotate-90" viewBox="0 0 72 72">
            ...
            <motion.circle
              ...
              initial={false}
              animate={{
                strokeDashoffset: shouldReduceMotion || isInView
                            ...
                            <div className="flex items-center gap-2">
                              <div className="flex-1 bg-slate-100 dark:bg-slate-800 h-2 rounded-full overflow-hidden">
                                <motion.div 
                                  ...
                                  initial={false}
                                  animate={{ width: shouldReduceMotion || isInView ? `${percent}%` : '0%' }}
                                  transition={{
                                    duration: shouldReduceMotion ? 0 : 0.7,
                                    delay: shouldReduceMotion ? 0 : Math.min(itemIndex * 0.05, 0.25),
                                    ease: [0.16, 1, 0.3, 1],
                                  }}
                                />
                              </div>
