    ...
    <AnimatePresence>
      ...
      >
        ...
        <motion.div
          ...
          className="ui-modal relative w-full max-w-md max-h-[min(85svh,85dvh)] overflow-y-auto shadow-2xl z-10 rounded-2xl my-auto"
          role="dialog"
          aria-modal="true"
        >
          <div className="sticky top-0 flex items-center justify-between px-5 py-4 border-b border-[var(--border-subtle)] bg-[var(--card-bg)]">
            ...
            <button
              type="button"
              onClick={onClose}
              className="p-1.5 text-[var(--ink-dim)] hover:text-[var(--ink)] transition"
