...
const topLevelDocumentSchemas = {
    ...
    active_course_enrollment_guards: identifiers_1.ActiveCourseEnrollmentGuardIdSchema,
...
exports.canonicalPaths = {
    ...
    activeCourseEnrollmentGuard: (id) => documentPath('active_course_enrollment_guards', id),
