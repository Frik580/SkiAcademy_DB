...
describe('canonical collections and paths', () => {
  ...
  it('builds only absolute canonical document and collection paths', () => {
    ...
    expect(canonicalPaths.adminLessonBookingsRevision()).toBe(
    ...
    expect(canonicalPaths.adminCoursesRevision()).toBe('/admin_runtime/admin_courses');
    expect(CanonicalDocumentPathSchema.parse('/admin_runtime/admin_courses')).toBe(
      '/admin_runtime/admin_courses'
    );
    expect(canonicalPaths.adminFinanceRevision()).toBe('/admin_runtime/admin_finance');
    expect(CanonicalDocumentPathSchema.parse('/admin_runtime/admin_finance')).toBe(
      '/admin_runtime/admin_finance'
    );
    expect(canonicalPaths.adminPeopleRevision()).toBe('/admin_runtime/admin_people');
