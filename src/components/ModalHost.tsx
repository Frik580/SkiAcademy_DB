...
import { NotificationHubModal } from './PushNotificationHub';
import { LazyLoad } from './LazyLoad';
import { ModalSkeleton } from './ui/Skeleton';
import { BodyScrollLock } from './ui/BodyScrollLock';

const BookingModal = React.lazy(() =>
  import('./BookingModal').then(({ BookingModal }) => ({ default: BookingModal }))
);
const CourseEnrollmentModal = React.lazy(() =>
  import('./CourseEnrollmentModal').then(({ CourseEnrollmentModal }) => ({
    default: CourseEnrollmentModal,
  }))
);
const CourseDetailsModal = React.lazy(() =>
  import('./CourseDetailsModal').then(({ CourseDetailsModal }) => ({
    default: CourseDetailsModal,
  }))
);
const InstructorReviewsModal = React.lazy(() =>
  import('./InstructorReviewsModal').then(({ InstructorReviewsModal }) => ({
