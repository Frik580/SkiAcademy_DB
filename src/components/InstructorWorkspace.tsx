...
export const InstructorWorkspace: React.FC<InstructorWorkspaceProps> = ({
  ...
  const [statusFilter, setStatusFilter] = useState<'all' | 'pending' | 'confirmed' | 'completed'>(
    'all'
  );
                  ...
                  <div className="flex flex-col md:flex-row justify-between items-start gap-4">
                    ...
                    <div className="space-y-3 flex-1">
                      <div className="flex items-center gap-3">
                        ...
                        <span
                          className={`px-2 py-0.5 text-[8px] font-mono uppercase font-bold rounded-xs ${
                            b.status === 'confirmed'
                                  ...
                                  >
                                    ...
                                    <div className="flex items-center gap-1.5">
                                      ...
                                      <div
                                        ...
                                        title={`${t('instructorLevel')}: ${studentLevel}`}
                                      >
                                        <img
                                ...
                                return (
                                  <div className="flex flex-wrap items-center justify-between gap-2 bg-white dark:bg-slate-900/60 p-2.5 border border-slate-200/70 dark:border-slate-800/70 rounded-xs hover:border-slate-300 transition-colors duration-200 w-full">
                                      ...
                                      <div>
                                        ...
                                        {((b as any).guestPhone || (b as any).guestEmail) && (
                                          <div className="text-[10px] font-mono text-[var(--ink-dim)] flex flex-wrap gap-2 mt-0.5">
                                            ...
                                            {(b as any).guestEmail && (
                                              <a
                                                href={`mailto:${(b as any).guestEmail}`}
                                                className="hover:text-accent"
                                              >
                                    ...
                                    <div className="flex items-center gap-2">
                                      ...
                                      <div
                                        className="flex items-center gap-1 bg-slate-100 dark:bg-slate-800 px-2 py-0.5 rounded-xs"
                                        title={`${t('instructorCurrentLevel')}: ${studentLevel}`}
                                      >
                                        <img
                                          key={`${theme}-${studentLevel}`}
                                          src={`https://storage.yandexcloud.net/carve/level/${theme === 'light' ? 'b' : 'w'}/${studentLevel}.png`}
                      ...
                      <div
                        className={`grid grid-cols-1 ${(b as any).isCourse ? '' : 'md:grid-cols-2'} gap-4 text-xs font-mono text-[var(--ink-dim)] border-t border-slate-200/60 dark:border-slate-800/60 pt-3`}
                      >
                        <div>
