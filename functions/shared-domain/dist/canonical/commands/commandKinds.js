...
exports.FORBIDDEN_GENERIC_COMMAND_KINDS = exports.COMMAND_KINDS = void 0;
exports.catalogExcludesGenericMutationCommands = catalogExcludesGenericMutationCommands;
exports.COMMAND_KINDS = [
...
function catalogExcludesGenericMutationCommands() {
    const catalog = new Set(exports.COMMAND_KINDS);
    return exports.FORBIDDEN_GENERIC_COMMAND_KINDS.every((kind) => !catalog.has(kind));
}
