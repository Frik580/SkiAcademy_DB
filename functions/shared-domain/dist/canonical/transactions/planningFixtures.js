...
exports.TRANSACTION_PLANNING_FIXTURES = void 0;
exports.syntheticBudgetBoundaryPlan = syntheticBudgetBoundaryPlan;
...
function planRepeatedReads(builder, count, pathPrefix, category) {
...
function planRepeatedMutations(builder, count, pathPrefix, category, estimatedPayloadBytes = DEFAULT_DOCUMENT_BYTES) {
    for (let index = 0; index < count; index += 1) {
 ...
 */
exports.TRANSACTION_PLANNING_FIXTURES = {
    individualBooking() {
        const builder = new transactionPlan_1.TransactionPlanBuilder();
        ...
        planRepeatedMutations(builder, 2, 'resource_claim_guards', 'resource_guard', DEFAULT_GUARD_MUTATION_BYTES);
    ...
    eightParticipantBooking() {
        ...
        planRepeatedMutations(builder, 24, 'resource_claim_guards', 'resource_guard', DEFAULT_GUARD_MUTATION_BYTES);
    ...
    eightParticipantsTenCourseDaysEnrollment() {
        const builder = new transactionPlan_1.TransactionPlanBuilder();
        ...
        planRepeatedMutations(builder, 160, 'resource_claim_guards', 'resource_guard', DEFAULT_GUARD_MUTATION_BYTES);
    ...
    courseTransfer() {
        ...
        planRepeatedMutations(builder, 80, 'resource_claim_guards', 'resource_guard', DEFAULT_GUARD_MUTATION_BYTES);
        planRepeatedMutations(builder, 3, 'payment_wallet', 'payment_wallet');
        planRepeatedMutations(builder, 1, 'command_idempotency', 'idempotency');
        (0, transactionPlan_1.planAuditOutboxContributions)(builder, {
    ...
    maximumOutboxObligationBoundary() {
        const builder = new transactionPlan_1.TransactionPlanBuilder();
        ...
        (0, transactionPlan_1.planAuditOutboxContributions)(builder, {
            ...
            outboxObligationCount: auditOutbox_1.AUDIT_CARDINALITY_LIMITS.outboxObligationsPerCommand,
        });
        return builder.build();
    },
};
function syntheticBudgetBoundaryPlan(shape, value) {
    const builder = new transactionPlan_1.TransactionPlanBuilder();
    if (shape === 'reads') {
