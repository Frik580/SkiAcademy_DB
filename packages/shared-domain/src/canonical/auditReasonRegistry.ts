...
const COMMAND_KIND_REASON_CODES: Partial<Record<CommandKind, readonly AuditReasonCode[]>> = {
  ...
  disable_account: ['manual_override', 'other'],
  enable_account: ['manual_override', 'other'],
  archive_participant: ['manual_override', 'other'],
  reactivate_participant: ['manual_override', 'other'],
  assign_participant_management_as_administrator: ['participant_management', 'manual_override'],
  ...
  update_own_account_contact: ['participant_management', 'other'],
  ...
  change_course_title: ['manual_override', 'other'],
  change_course_price: ['manual_override', 'other'],
  change_course_capacity: ['manual_override', 'other'],
  archive_course: ['manual_override', 'other'],
  reactivate_course: ['manual_override', 'other'],
  add_course_roster_instructor: ['manual_override', 'other'],
  remove_course_roster_instructor: ['manual_override', 'other'],
  reschedule_course_day: ['manual_override', 'other'],
  remove_course_day: ['manual_override', 'other'],
  update_course_catalog_content: ['manual_override', 'other'],
  create_administrative_availability_block: ['manual_override', 'other'],
  reschedule_administrative_availability_block: ['manual_override', 'other'],
  release_administrative_availability_block: ['manual_override', 'other'],
