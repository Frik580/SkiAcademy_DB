                      ...
                      <div className="space-y-1">
                        ...
                        >
                          <option value="beginner" className="bg-[var(--bg)] text-[var(--ink)]">
                            {getDifficultyLabel('beginner', language, 'booking')}
                          </option>
                          <option value="intermediate" className="bg-[var(--bg)] text-[var(--ink)]">
                            {getDifficultyLabel('intermediate', language, 'booking')}
                          </option>
                          <option value="advanced" className="bg-[var(--bg)] text-[var(--ink)]">
                            {getDifficultyLabel('advanced', language, 'booking')}
                          </option>
                          <option value="freeride" className="bg-[var(--bg)] text-[var(--ink)]">
                            {getDifficultyLabel('freeride', language, 'booking')}
                          </option>
                          <option value="freestyle" className="bg-[var(--bg)] text-[var(--ink)]">
                            {getDifficultyLabel('freestyle', language, 'booking')}
                          </option>
                        </select>
                      </div>
                    </div>
                ...
                <div className="flex items-center justify-between px-4 py-3 rounded-none border border-[var(--border)] text-xs bg-black/5">
                  {userProfile?.isClientActive === false ? (
                    ...
                    <div className="flex items-center gap-2 text-emerald-600 dark:text-emerald-400 font-mono text-[10px] uppercase tracking-wider">
                      ...
                      <span>
                        {t('walletBalancePrefix')} <strong>${userBalance}</strong>{' '}
                        {t('walletSufficient')}
                      </span>
                    </div>
                  ) : (
